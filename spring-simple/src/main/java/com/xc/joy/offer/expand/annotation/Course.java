...
public class Course {
    ...
    @PersonInfoAnnotation(name = "lxcecho", language = {"Java", "C++", "Go", "Python", "PHP", "JS"})
    private String author;

    @CourseInfoAnnotation(courseName = "校园商铺", courseTag = "实战", courseProfile = "手把手教会从前端到后端开发多店铺商铺管理系统，"
            + "可以用在毕设创业中，学习完会对SSM以及Springboot有一个"
            + "全面的了解", courseIndex = 101)
